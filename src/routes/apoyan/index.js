  ...
  render({
    ...
    return (<div class={`${style.profile} page main-container`} style={{
      ...
      <Card style={{
        ...
        textRendering: 'optimizeLegibility'}} ><i>
        Gracias a tu apoyo podemos seguir mejorando para disfrutar más arte juntos.
        </i></p>
        <p style={{fontSize: '1.5rem', textAlign: 'right', fontFamily: "Sign Painter"}} >
